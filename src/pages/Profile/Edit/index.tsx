 ...
 * @LastEditors: chenjie
 * @LastEditTime: 2022-07-30 09:35:09
...
import {
  ...
  updateUserProfile,
  updateUserPhoto,
} from '@/store/festures/profile-slice';
      ...
      <div className="content">
        ...
        <div className="wrapper">
          ...
          <List className="profile-list">
              ...
              extra={
                <span className="avatar-wrapper">
                  <img
                    ...
                    src={
                      state.photo ||
                      'https://pic3.zhimg.com/v2-86e7af1f4d8fe235ea886394838b59e3_is.jpg?source=32738c0c'
                    }
                    alt=""
                  />
                </span>
            ...
            <Item
              arrow
              extra={state.name || '怎么吃不饱'}
              onClick={() => showInput('name', state.name)}
            >
              昵称
            </Item>
            <Item
              arrow
              extra={
                <span className={classNames('intro', 'normal')}>{state.intro || '未填写'}</span>
              }
          ...
          <List className="profile-list">
            <Item
              arrow
              extra={state.gender === 0 ? '男' : '女'}
              onClick={() => handleShow('gender')}
            >
              性别
            </Item>
